...
class SearchScreen extends Component {
	...
	onSearchFinished(error) {
		if (error) {
			this.setState({ message: error, isWaiting: false });
		}
	}
	...
	onLocationPress() {
		...
		navigator.geolocation.getCurrentPosition(
			position => {
				...
				this.props.actions.searchByPosition(currentPosition, this.onSearchFinished.bind(this));
			},
			error => {
				this.setState({
	...
	onSearchPress() {
		...
		this.props.actions.search(this.state.searchQuery, this.onSearchFinished.bind(this));
	}
